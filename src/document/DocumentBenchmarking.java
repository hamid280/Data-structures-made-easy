	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
            ...
            for (int i = 0; i < trials ; i++) {
                BasicDocument basicDocument = new BasicDocument(textRead);
                basicDocument.getFleschScore();
            }
            long endTimeBD = System.nanoTime();
            double timeTakenBD = ((double)(endTimeBD - startTimeBD)/1000000000);
            System.out.print(timeTakenBD + "\t");

            long startTimeED = System.nanoTime();
            for (int i = 0; i <trials; i++) {
                EfficientDocument efficientDocument = new EfficientDocument(textRead);
                efficientDocument.getFleschScore();
            }
            long endTimeED = System.nanoTime();
            double timeTakenED = ((double)(endTimeED - startTimeED)/1000000000);
            System.out.print(timeTakenED + "\n");
        }
	}
